...
from app.domain.entities import DictionaryItemEntity
from app.infrastructure.repositories.default_dictionaries import DEFAULT_DICTIONARY_ITEMS, DEPRECATED_DICTIONARY_CODES
