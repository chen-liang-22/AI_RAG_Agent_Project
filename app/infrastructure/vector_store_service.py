...
from core.model.factory import embed_model  # embedding 模型，用于把文本分片转成向量
...
from app.infrastructure.file_storage_service import get_file_storage_service  # MinIO 文件读取服务
...
from core.utils.qdrant_options import (
...
class VectorStoreService:
    ...
    def delete_vectors_by_metadata(field_name: str, field_value: str, collection_name: str | None = None) -> None:
        ...
        部分业务除了 document_id，还需要按 batch_id、version_group_id 等业务字段删除 points。
        """
